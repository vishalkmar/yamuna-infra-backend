...
const M = require('../models/LeadTemplateModel');

exports.list = asyncHandler(async (req, res) => success(res, await M.adminList()));
exports.create = asyncHandler(async (req, res) => success(res, await M.create(req.body), 'Template added', 201));
exports.update = asyncHandler(async (req, res) => {
  const ok = await M.update(req.params.id, req.body);
  if (!ok) throw new AppError('Template not found', 404);
